...
export default function CreateNoteForm() {
	...
	return (
		<form className="p-8 w-[45rem] mx-auto h-screen flex flex-col gap-4" onSubmit={handleSubmit}>
			...
			<Card className="bg-black rounded-xl border-0 grow p-6">
				<CardContent className="flex flex-col gap-4 p-0">
					...
					/>
					<Textarea className="bg-[#312d2d] text-white border-none outline-none ring-gray-800"
					...
					<div>
						<Button type='submit' className="bg-[#994bff] text-white w-32 border border-[#994bff] hover:bg-white hover:text-[#994bff]">
							Create
						</Button>
					</div>
				</CardContent>
